    ...
    $jumlah=null;
    //Query SQL
    $sql="select saat_kematian,COUNT(*) as 'total' from kematianibu GROUP by saat_kematian";
    $hasil=mysqli_query($conn,$sql);

    while ($data = mysqli_fetch_array($hasil)) {
        //Mengambil nilai jurusan dari database
        $saat_kematian=$data['saat_kematian'];
        $nama_saat_kematian .= "'$saat_kematian'". ", ";
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Grafik Saat Kematian</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index2.php">Beranda</a></li>
                            <li class="breadcrumb-item active">Grafik Saat Kematian</li>
                        </ol>
		...
		<script>
			...
			var chart = new Chart(ctx, {
				...
				data: {
					labels: [<?php echo $nama_saat_kematian; ?>],
					datasets: [{
						label:'',
