						...
						<ol class="breadcrumb mb-4">
							...
							<div class ="w-50 mx-auto border p-3 mt-5 mb-5">
								<form action="add.php" method="post">
									...
									<input type="text" id="id" name="nik" class="form-control" required> 
									
									<label for="nik">Nama Ibu</label>
									<input type="text" id="nama_ibu" name="nama_ibu" class="form-control" required>
									
									<label for="nik">Usia</label>
									<input type="text" id="usia" name="usia" class="form-control" required>
									
									<label for="nik">Desa/Kelurahan</label>
									<input type="text" id="desa_kelurahan" name="desa_kelurahan" class="form-control" required>
									
									<label for="nik">Kecamatan</label>
									<input type="text" id="kecamatan" name="kecamatan" class="form-control" required>
									
									<label for="nik">Kabupaten/Kota</label>
									<input type="text" id="kabupaten_kota" name="kabupaten_kota" class="form-control" required>
									...
									<label for="nik">Tanggal Kematian</label>
									<input type="date" id="tanggal_kematian" name="tanggal_kematian" class="form-control" required>
							...
							if (isset($_POST['tambah'])) {
								...
								$sqlInsert = "INSERT INTO kematianibu(id,nik,nama_ibu,usia,desa_kelurahan,kecamatan,kabupaten_kota,tempat_kematian,tanggal_kematian,penyebab_kematian_sementara,penolong_persalinan,saat_kematian) VALUE ('$id','$nik','$nama_ibu','$usia','$desa_kelurahan','$kecamatan','$kabupaten_kota','$tempat_kematian','$tanggal_kematian','$penyebab_kematian_sementara','$penolong_persalinan','$saat_kematian')";			
